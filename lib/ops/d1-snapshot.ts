...
export async function loadOpsFixtureSnapshotFromD1(
  ...
  const [
    ...
    db.select().from(opsVendorReminders).where(tenant(opsVendorReminders.organizationId)),
    ...
    db.select().from(opsVendorQualifications).where(tenant(opsVendorQualifications.organizationId)),
    db.select().from(opsVendorComplianceDocuments).where(tenant(opsVendorComplianceDocuments.organizationId)),
    db.select().from(opsVendorComplianceAlerts).where(tenant(opsVendorComplianceAlerts.organizationId)),
    db.select().from(opsVendorContracts).where(tenant(opsVendorContracts.organizationId)),
    db.select().from(opsContractVersions).where(tenant(opsContractVersions.organizationId)),
    db.select().from(opsContractScopes).where(tenant(opsContractScopes.organizationId)),
    db.select().from(opsRateCardLines).where(tenant(opsRateCardLines.organizationId)),
    db.select().from(opsServiceLevelPolicies).where(tenant(opsServiceLevelPolicies.organizationId)),
    db.select().from(opsSchedulingPolicies).where(tenant(opsSchedulingPolicies.organizationId)),
    db.select().from(opsVendorCapacity).where(tenant(opsVendorCapacity.organizationId)),
    db.select().from(opsRequests).where(tenant(opsRequests.organizationId)),
    db.select().from(opsRequestImpactAssessments).where(tenant(opsRequestImpactAssessments.organizationId)),
    db.select().from(opsWorkOrders).where(tenant(opsWorkOrders.organizationId)),
    db.select().from(opsWorkOrderVisitHolds).where(tenant(opsWorkOrderVisitHolds.organizationId)),
    db.select().from(opsApprovalPolicies).where(tenant(opsApprovalPolicies.organizationId)),
    db.select().from(opsApprovalRequests).where(tenant(opsApprovalRequests.organizationId)),
    db.select().from(opsApprovalDecisions).where(tenant(opsApprovalDecisions.organizationId)),
    ...
    db.select().from(opsSiteVisitWorkOrders).where(tenant(opsSiteVisitWorkOrders.organizationId)),
    db.select().from(opsWorkOrderVerifications).where(tenant(opsWorkOrderVerifications.organizationId)),
    ...
    db.select().from(opsWorkflowTasks).where(tenant(opsWorkflowTasks.organizationId)),
    db.select().from(opsWorkflowTaskSlaPauses).where(tenant(opsWorkflowTaskSlaPauses.organizationId)),
    db.select().from(opsWorkflowTaskSlaResumes).where(tenant(opsWorkflowTaskSlaResumes.organizationId)),
    ...
    db.select().from(opsPmWorkItems).where(tenant(opsPmWorkItems.organizationId)),
    db.select().from(opsChecklistResponses).where(tenant(opsChecklistResponses.organizationId)),
    db.select().from(opsServiceRuns).where(tenant(opsServiceRuns.organizationId)),
    db.select().from(opsRouteStops).where(tenant(opsRouteStops.organizationId)),
    db.select().from(opsServiceRunWorkOrders).where(tenant(opsServiceRunWorkOrders.organizationId)),
    db.select().from(opsServiceRunResponses).where(tenant(opsServiceRunResponses.organizationId)),
    db.select().from(opsVendorWarrantyProfiles).where(tenant(opsVendorWarrantyProfiles.organizationId)),
    db.select().from(opsWarrantyRules).where(tenant(opsWarrantyRules.organizationId)),
    db.select().from(opsWarrantyCoverageLines).where(tenant(opsWarrantyCoverageLines.organizationId)),
    db.select().from(opsRepairItems).where(tenant(opsRepairItems.organizationId)),
    db.select().from(opsAppliedWarranties).where(tenant(opsAppliedWarranties.organizationId)),
    db.select().from(opsWarrantyAmendments).where(tenant(opsWarrantyAmendments.organizationId)),
    db.select().from(opsManufacturerWarranties).where(tenant(opsManufacturerWarranties.organizationId)),
    db.select().from(opsWarrantyCases).where(tenant(opsWarrantyCases.organizationId)),
    db.select().from(opsQuotes).where(tenant(opsQuotes.organizationId)),
    db.select().from(opsAuthorizations).where(tenant(opsAuthorizations.organizationId)),
    db.select().from(opsInvoices).where(tenant(opsInvoices.organizationId)),
    db.select().from(opsInvoiceLines).where(tenant(opsInvoiceLines.organizationId)),
    db.select().from(opsInvoiceLineAllocations).where(tenant(opsInvoiceLineAllocations.organizationId)),
    db.select().from(opsInvoiceExceptions).where(tenant(opsInvoiceExceptions.organizationId)),
    db.select().from(opsInvoiceAdjustments).where(tenant(opsInvoiceAdjustments.organizationId)),
    db.select().from(opsServiceDiscrepancies).where(tenant(opsServiceDiscrepancies.organizationId)),
    db.select().from(opsValueEvents).where(tenant(opsValueEvents.organizationId)),
