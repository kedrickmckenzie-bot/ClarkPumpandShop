...
export async function loadOpsFixtureSnapshotFromPostgres(
  ...
  const [
    ...
    tenantRows(pool, "ops_vendor_reminders", organizationId),
    ...
    tenantRows(pool, "ops_vendor_compliance_alerts", organizationId),
    ...
    tenantRows(pool, "ops_work_order_visit_holds", organizationId),
    ...
    tenantRows(pool, "ops_component_lifecycle_events", organizationId),
