...
function harness() {
  ...
  fixture.workOrders.push(
    { id: "wo-run-104", organizationId: NORTHLINE_ORGANIZATION_ID, number: "NL-2026-R104", storeId: "store-northline-104", problem: "Beer cave door seal inspection", categoryKey: "refrigeration", priority: "planned", status: "accepted", version: 0, accountableParty: "Summit Refrigeration", nextAction: "Schedule accepted service", dueAt: "2026-08-26T15:00:00.000Z", escalationTo: "Facilities coordinator", nte: { amountMinor: 75_000, currency: "USD" }, createdAt },
    { id: "wo-run-105", organizationId: NORTHLINE_ORGANIZATION_ID, number: "NL-2026-R105", storeId: "store-northline-105", problem: "Walk-in evaporator inspection", categoryKey: "refrigeration", priority: "planned", status: "accepted", version: 0, accountableParty: "Summit Refrigeration", nextAction: "Schedule accepted service", dueAt: "2026-08-26T15:00:00.000Z", escalationTo: "Facilities coordinator", nte: { amountMinor: 95_000, currency: "USD" }, createdAt },
  );
