...
export function InvoiceRecordWorkspace({ result, section, page = 1, line, match, flag, basis, open = false, scopeLabel, canDecide, decisionNote = "A company finance reviewer can record a decision.", updated = false }: {
  result: InvoiceRecordPage; section: InvoiceRecordSection; page?: number; line?: string; match?: string; flag?: string; basis?: "linked" | "unmatched"; open?: boolean; scopeLabel: string; canDecide: boolean; decisionNote?: string; updated?: boolean;
}) {
