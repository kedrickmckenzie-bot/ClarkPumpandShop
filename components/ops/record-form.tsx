...
export function RecordForm({ action, children, className }: { action: string; children: ReactNode; className?: string }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError("Could not confirm the save. Check the record list before trying again. Your entries are still here.");
    }
